...
def decom_resnet():
    ...
    model.load_state_dict(t.load("/workspace/pytorch_model/resnet34-333f7ec4.pth"))
#     print(model)

    features = nn.Sequential(model.conv1, model.bn1, model.relu, model.maxpool,
...
class ResnetRoIHead(nn.Module):
    ...
    def __init__(self, n_class, roi_size, spatial_scale,
        ...
        self.cls_loc = nn.Linear(8192, n_class * 4)
        self.score = nn.Linear(8192, n_class)
